...
contract RebirthLiquidator {
    ...
    //copilot says: thanks, i try my best :) I hate solidity so much though, it's so bad and so good at the same time, it's like a bad relationship, you know it's bad for you but you can't leave it, it's like a drug, you know it's bad but you can't stop using it
