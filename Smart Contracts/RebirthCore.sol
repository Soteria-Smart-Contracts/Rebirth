...
//This is how the amount of relaunch shares is calculated: the contract finds the ether value of the deposited memecoins and gets 1 relaunch share per 0.001 ether value of the deposited memecoin, then when a new pool is created, the contract finds the ether value of the deposited relaunch shares and then divides that by 0.001 to get the amount of memecoin that the user can deposit into the new pool
