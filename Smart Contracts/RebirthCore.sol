...
contract RebirthProtocolCore{
    ...
    function AddFreemint(address User, uint256 Amount) public  {
        NFT_Freemints[User] += Amount;
    }

    function AddRelaunchShare(address User, uint256 Amount) public onlySuperAdmin {
...
contract RebirthLiquidator {
    ...
    function liquidate(address memecoinAddress, uint256 amount, AlternativePayoutOption AlternatePayoutChoice) external {
